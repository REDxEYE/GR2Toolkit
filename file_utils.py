...
class Buffer(abc.ABC, io.RawIOBase):
    ...
    def copy_settings(self, other: 'Buffer'):
        self._endian = other._endian
        self._ptr_type = other._ptr_type

    @property
    def is_64(self):
        return self._ptr_type == "Q"
    ...
    def read_ptr(self):
        return self._read(self._ptr_type)
    ...
    def set_endian(self, little_endian: bool):
        self._endian = '<' if little_endian else '>'

    def set_ptr_type(self, ptr_type):
